pipeline {
  ...
  post {
    ...
    failure {
      emailext(attachLog: true, body: "Success build in project:${PROJECT_NAME} Failed ${FAILED_STAGE}", subject: 'Failed: $PROJECT_NAME - #$BUILD_NUMBER', to: "${EMAIL_TO}", from: 'jenkins@example.com')
    }
